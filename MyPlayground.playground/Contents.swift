...
//  let genreList = Dictionary(zip(genres, plays.enumerated()), uniquingKeysWith: { return $0.element > $1.element ? $0: $1 }).sorted(by: { $0.value.element > $1.value.element }).compactMap { $0.value.offset }
//  return genreList
//}

func solution4(_ genres:[String], _ plays:[Int]) -> [Int] {
  Dictionary(zip(genres, plays.enumerated()), uniquingKeysWith: { return $0.element > $1.element ? $0: $1 })
